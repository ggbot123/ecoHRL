...
if __name__ == "__main__":
    ...
    main(
        ...
        # hiro_low_pretrained_path="./models/hiro_260415_lowonly_reUni_fixedHERv2_upp10_amax3_dmin15_10/hiro_low_final.zip",
        ...
        run_name=f"hiro_260418_highonly_reUni_fixedHERv2_amax3_dmin15_10",
