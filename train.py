...
if __name__ == "__main__":
    ...
    main(
        ...
        # hiro_low_pretrained_path="./models/hiro_260412_lowonly_reUni_fixedHERsimp_amax3_dmin15_10/hiro_low_final.zip",
        # hiro_low_pretrained_path="./models/hiro_260412_lowonly_reUni_fixedHERv2_amax3_dmin15_10/hiro_low_final.zip",
        hiro_low_target_entropy="auto",
        hiro_low_target_entropy_scale=1,

        # run_name=f"hiro_260413_highonly_reUni_amax3_dmin15_10_vf3T40_gateVxPen",
        # run_name=f"hiro_260413_highonly_reUni_amax3_dmin15_10_vf0T40_linVxPen",
        # run_name=f"hiro_260413_highonly_reUni_fixedHERsimp_amax3_dmin15_10",
        # run_name=f"hiro_260413_highonly_reUni_fixedHERv2_amax3_dmin15_10",
        # run_name=f"hiro_260415_lowonly_reUni_fixedHERv2_amax3_dmin15_10",
        run_name=f"hiro_260415_lowonly_reUni_fixedHERv2_upp10_amax3_dmin15_10",
        # run_name=f"hiro_260415_lowonly_reUni_fixedHERv2_amax3_dmin15_10",
