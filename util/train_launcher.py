...
def run_training(
    *,
    ...
    hiro_high_reachable_diagnostics: bool = False,
    hiro_high_q_replay_debug: bool = True,
    hiro_low_transition_detail_csv: bool = False,
    hiro_low_transition_detail_interval_hi: int = 1,
    ...
    hiro_low_offline_eval_enabled: bool = False,
    hiro_low_offline_eval_cases_path: str = "debug/hiro_low_eval_cases_snapshot012.json",
    hiro_low_offline_eval_freq: int = 200_000,
    hiro_low_offline_eval_sample_size: int = 90,
    hiro_low_offline_eval_build_if_missing: bool = True,
    hiro_low_offline_eval_cases_per_bucket: int = 8,
    hiro_low_offline_eval_seed: int = MASTER_SEED,
    hiro_low_offline_eval_traffic_front_gap: float = 12.0,
    hiro_low_offline_eval_traffic_rear_gap: float = 8.0,
    record_video: bool = False,
    ...
    if algo == "ppo":
        ...
        run_hiro_training(
            ...
            hiro_high_reachable_diagnostics=hiro_high_reachable_diagnostics,
            ...
            hiro_low_transition_detail_interval_hi=hiro_low_transition_detail_interval_hi,
            ...
            hiro_low_offline_eval_enabled=hiro_low_offline_eval_enabled,
            hiro_low_offline_eval_cases_path=hiro_low_offline_eval_cases_path,
            hiro_low_offline_eval_freq=hiro_low_offline_eval_freq,
            hiro_low_offline_eval_sample_size=hiro_low_offline_eval_sample_size,
            hiro_low_offline_eval_build_if_missing=hiro_low_offline_eval_build_if_missing,
            hiro_low_offline_eval_cases_per_bucket=hiro_low_offline_eval_cases_per_bucket,
            hiro_low_offline_eval_seed=hiro_low_offline_eval_seed,
            hiro_low_offline_eval_traffic_front_gap=hiro_low_offline_eval_traffic_front_gap,
            hiro_low_offline_eval_traffic_rear_gap=hiro_low_offline_eval_traffic_rear_gap,
...
def run_hiro_training(
    *,
    ...
    hiro_high_reachable_diagnostics: bool,
    ...
    hiro_low_transition_detail_interval_hi: int,
    hiro_low_her_debug_csv_interval_steps: int,
    hiro_low_her_debug_sample_prob: float,
    hiro_low_debug_summary_interval_steps: int,
    hiro_low_offline_eval_enabled: bool,
    hiro_low_offline_eval_cases_path: str,
    hiro_low_offline_eval_freq: int,
    hiro_low_offline_eval_sample_size: int,
    hiro_low_offline_eval_build_if_missing: bool,
    hiro_low_offline_eval_cases_per_bucket: int,
    hiro_low_offline_eval_seed: int,
    hiro_low_offline_eval_traffic_front_gap: float,
    hiro_low_offline_eval_traffic_rear_gap: float,
    record_video: bool,
    record_video_envs: str,
    video_episode_freq: int,
) -> None:
    ...
    try:
        ...
        env_action_cfg = dict(env_overrides).get("action", {})
        if not isinstance(env_action_cfg, Mapping):
            env_action_cfg = {}
        low_eval_acceleration_range = list(env_action_cfg.get("acceleration_range", [-3.0, 2.0]))
        train_hiro(
            env=env,
            total_timesteps=total_timesteps,
            log_dir=log_dir,
            ...
            high_reachable_diagnostics=bool(hiro_high_reachable_diagnostics),
            low_transition_detail_csv=bool(hiro_low_transition_detail_csv),
            low_transition_detail_envs=_HIRO_LOW_TRANSITION_DETAIL_ENVS,
            low_transition_detail_interval_hi=max(1, int(hiro_low_transition_detail_interval_hi)),
            ...
            low_offline_eval_config={
                "enabled": bool(hiro_low_offline_eval_enabled),
                "cases_path": str(hiro_low_offline_eval_cases_path),
                "eval_freq": int(hiro_low_offline_eval_freq),
                "sample_size": int(hiro_low_offline_eval_sample_size),
                "build_if_missing": bool(hiro_low_offline_eval_build_if_missing),
                "seed": int(hiro_low_offline_eval_seed),
                "env_id": env_id,
                "scenario_name": scenario_name,
                "scenario_module": scenario_module,
                ...
                "build_config": {
                    ...
                    "output_path": str(hiro_low_offline_eval_cases_path),
                    "env_id": env_id,
                    "scenario_name": scenario_name,
                    "scenario_module": scenario_module,
                    "env_overrides": dict(env_overrides),
                    "cases_per_bucket": int(hiro_low_offline_eval_cases_per_bucket),
                    "seed": int(hiro_low_offline_eval_seed),
                    "use_forward_sim_constraints": True,
                    "traffic_front_gap": float(hiro_low_offline_eval_traffic_front_gap),
                    "traffic_rear_gap": float(hiro_low_offline_eval_traffic_rear_gap),
                    "acceleration_range": low_eval_acceleration_range,
                },
            },
            run_metadata={
                "algo": "hiro",
                ...
                "hiro_low_target_entropy_scale": hiro_low_target_entropy_scale,
                "hiro_high_transition_csv_envs": hiro_high_transition_csv_envs,
                "hiro_high_reachable_diagnostics": bool(hiro_high_reachable_diagnostics),
                ...
                "hiro_low_transition_detail_interval_hi": max(1, int(hiro_low_transition_detail_interval_hi)),
