...
def run_training(
    *,
    ...
    hiro_low_her_debug_csv_max_rows_per_flush: int = 200,
    hiro_low_her_debug_max_records: int = 20000,
    hiro_low_her_debug_sample_prob: float = 0.0,
    hiro_low_debug_summary_interval_steps: int = 10000,
    hiro_low_debug_env_step_interval_steps: int = 1000,
    record_video: bool = False,
    ...
    if algo == "ppo":
        ...
        run_hiro_training(
            ...
            hiro_low_her_debug_csv_max_rows_per_flush=hiro_low_her_debug_csv_max_rows_per_flush,
            hiro_low_her_debug_max_records=hiro_low_her_debug_max_records,
            ...
            hiro_low_debug_env_step_interval_steps=hiro_low_debug_env_step_interval_steps,
...
def run_hiro_training(
    *,
    ...
    hiro_low_her_debug_csv_max_rows_per_flush: int,
    hiro_low_her_debug_max_records: int,
    hiro_low_her_debug_sample_prob: float,
    hiro_low_debug_summary_interval_steps: int,
    hiro_low_debug_env_step_interval_steps: int,
    record_video: bool,
    record_video_envs: str,
    record_video_global_view: bool,
    video_episode_freq: int,
    ...
    try:
        train_hiro(
            ...
            low_her_debug_csv_max_rows_per_flush=int(hiro_low_her_debug_csv_max_rows_per_flush),
            low_her_debug_max_records=int(hiro_low_her_debug_max_records),
            ...
            low_debug_env_step_interval_steps=int(hiro_low_debug_env_step_interval_steps),
            run_metadata={
                "algo": "hiro",
                "run_name": run_name,
                "scenario_name": scenario_name,
                ...
                "hiro_low_her_debug_csv_max_rows_per_flush": int(hiro_low_her_debug_csv_max_rows_per_flush),
                "hiro_low_her_debug_max_records": int(hiro_low_her_debug_max_records),
                ...
                "hiro_low_debug_env_step_interval_steps": int(hiro_low_debug_env_step_interval_steps),
