...
def init_kinematics_meta(env, obs_flat: np.ndarray, keep_features: Sequence[str] = ("x", "y", "vx", "vy")) -> Tuple[int, int, List[str], List[int], np.ndarray]:
    ...
    return n_veh, feat_dim, feature_names, ego_feature_idx
