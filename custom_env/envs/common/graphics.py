...
from custom_env.envs.common.action import (
    ActionType,
    ContinuousAction,
    DiscreteMetaAction,
)
from custom_env.road.graphics import RoadGraphics, WorldSurface
from custom_env.vehicle.graphics import VehicleGraphics


if TYPE_CHECKING:
    from custom_env.envs import AbstractEnv
    from custom_env.envs.common.abstract import Action
...
class ObservationGraphics:
    ...
    def display(cls, obs, sim_surface):
        from custom_env.envs.common.observation import LidarObservation
